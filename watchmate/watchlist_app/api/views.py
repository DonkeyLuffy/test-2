...
from watchmate.watchlist_app.api.serializers import WatchListSerializer,StreamPlatformSerializer # Class Based View
...
class WatchDetailAV(APIView):
    ...
    def put(self, request, pk):
        movie = WatchList.objects.get(pk=pk)
        # data=request.data gets the data and then get serailised, 
        # also we need to pass in the movie object in the serializer
